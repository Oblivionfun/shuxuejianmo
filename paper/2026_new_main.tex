...
\newcommand{\placeholder}{\textcolor{gray}{（正式测试数据待取得后替换；本稿中的数值均明确标注为本地合成或官方演练。）}}
\begin{document}
\begin{center}
